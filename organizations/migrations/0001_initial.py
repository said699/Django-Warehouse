    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, null=True, upload_to='organizations_logo/%Y/%m/%d', verbose_name='Логотип')),
                ('currency', models.CharField(choices=[('USD', '$'), ('RUB', '₽'), ('UZS', 'so`m')], max_length=3, verbose_name='Валюта учёта')),
